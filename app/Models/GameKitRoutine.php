...
class GameKitRoutine extends Model
{
    ...
    {
        return $this->hasMany(GameKitRoutineVersion::class, 'gamekit_routine_id')->orderByDesc('version');
    }
    ...
    {
        return $this->hasOne(GameKitRoutineVersion::class, 'gamekit_routine_id')->latestOfMany('version');
    }

    public function links(): HasMany
    {
        return $this->hasMany(GameKitRoutineLink::class, 'gamekit_routine_id');
    }
}
