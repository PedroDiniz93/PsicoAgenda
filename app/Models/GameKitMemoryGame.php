...
class GameKitMemoryGame extends Model
{
    ...
    public function pairs(): HasMany { return $this->hasMany(GameKitMemoryPair::class, 'gamekit_memory_game_id')->orderBy('position'); }
    public function sessions(): HasMany { return $this->hasMany(GameKitMemorySession::class, 'gamekit_memory_game_id'); }
}
